...
<div className="Parent_error_class">
    ...
    <NavAdmin/>
               ...
               <label htmlFor="from"><b>From: </b></label >
                ...
                <br/><br/>
                <button className="report_button" type="submit" onClick={()=>this.generateSalesReport(document.getElementById('from').value,document.getElementById('to').value)}>Sales Report</button>
                <button className="report_button" type="submit" onClick={()=>this.generatePurchaseReport(document.getElementById('from').value,document.getElementById('to').value)}>Purchase Report</button>
                <Link to="/adminmain"><button className="report_button" type="cancel">Cancel</button></Link>
                </form>
                    <div class="limiter">
